...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get login_button_demo => 'Essayer le mode démo';

  @override
  String get login_demo_tagline =>
      'Explorez l\'application avec des données génériques';
  ...
  String home_subscription_itemLimit(int count, int limit) {
    return 'Limite d\'articles : $count / $limit';
  }

  @override
  String get home_subscription_upgradeForUnlimited => 'Passer à l\'illimité';

  @override
  String get home_subscription_limitReached =>
      'Limite atteinte ! Améliorez maintenant.';

  @override
  String get home_premium_banner_title => 'Débloquez un Potentiel Illimité';

  @override
  String get home_premium_banner_subtitle =>
      'Gérez un nombre illimité d\'articles et de membres de la famille avec SeasonBox Premium.';

  @override
  String get home_premium_banner_button => 'Passer à Premium';

  @override
  String get home_search_hint => 'Rechercher articles, tailles ou #tag';

  @override
  String get home_search_hint_revamped =>
      'Rechercher par titre, taille ou #tag';
  ...
  @override
  String get home_reminder_winterTitle => 'L\'Hiver Approche';

  @override
  String get home_reminder_winterMessage =>
      'Gardez votre famille au chaud. Passez en revue les manteaux d\'hiver, les bottes et les vêtements thermiques.';

  @override
  String get home_reminder_springTitle => 'Le Printemps Approche';

  @override
  String get home_reminder_springMessage =>
      'Il est temps de porter des couches plus légères. Vérifiez si les vestes de printemps et les vêtements de pluie de l\'année dernière conviennent toujours.';

  @override
  String get home_reminder_summerTitle => 'L\'Été Approche';

  @override
  String get home_reminder_summerMessage =>
      'Préparez-vous pour le soleil. Passez en revue les maillots de bain, les shorts et les chaussures d\'été.';
  ...
  @override
  String get profile_subscription_statusFree => 'Plan Gratuit';
  ...
  @override
  String get profile_setting_statusTracking => 'Activer le suivi d\'état';

  @override
  String get profile_setting_statusTrackingSubtitle =>
      'Savoir si les articles sont utilisés ou stockés';

  @override
  String get profile_setting_quickAddItem => 'Ajout Rapide d\'Article';

  @override
  String get profile_setting_quickAddItemSubtitle =>
      'Démarrer automatiquement avec l\'appareil photo pour les nouveaux articles';
  ...
  String get addMember_field_birthdate_explanation =>
      'La date de naissance est utilisée pour calculer l\'âge et fournir des prévisions de croissance spécifiques à l\'âge.';
  ...
  String get addMember_section_sizes_explanation =>
      'Les tailles actuelles sont utilisées comme base pour prédire les tailles futures en fonction des modèles de croissance.';
  ...
  @override
  String get printLabels_title => 'Imprimer les étiquettes';

  @override
  String get printLabels_selectAll => 'Tout sélectionner';

  @override
  String get printLabels_deselectAll => 'Tout déselectionner';
  ...
  String get printLabels_noStorageSelected =>
      'Veuillez sélectionner au moins un lieu de stockage.';

  @override
  String get printLabels_searchHint => 'Filtrer les lieux de stockage...';

  @override
  String get printLabels_labelSubtitle => 'Étiquette de stockage';
  ...
  @override
  String get members_birthdate_notSet => 'Date de naissance non définie';
  ...
  String get members_dialog_birthdateRequired_message =>
      'Une date de naissance est nécessaire pour calculer l\'âge du membre et fournir des prévisions de croissance et des jalons précis sur les graphiques.';
  ...
  String get members_dialog_sizeRequired_title =>
      'Information de taille requise';

  @override
  String get members_dialog_sizeRequired_message =>
      'Les tailles actuelles des vêtements ou des chaussures sont nécessaires comme base pour prédire les tailles futures en fonction des modèles de croissance.';

  @override
  String get members_dialog_sizeRequired_button => 'Définir les tailles';
  ...
  String members_growthChart_noGrowth(String name) {
    return '$name a atteint sa maturité physique. La croissance standard se termine généralement après 18 ans.';
  }

  @override
  String get members_growthChart_reference =>
      'Les modèles de croissance sont basés sur les normes de croissance de l\'enfant de l\'Organisation mondiale de la Santé (OMS).';
  ...
  @override
  String get items_filter_title => 'Filtres';

  @override
  String get items_filter_category => 'Catégorie';

  @override
  String get items_filter_gender => 'Genre';

  @override
  String get items_filter_status => 'État';

  @override
  String get items_filter_member => 'Membre';

  @override
  String get items_filter_active => 'Filtres actifs';
  ...
  String get subscription_subtitle =>
      'Choisissez le meilleur plan pour votre famille';
  ...
  @override
  String get subscription_tier_freeTitle => 'Niveau Gratuit';

  @override
  String get subscription_tier_premiumTitle => 'Niveau Premium';

  @override
  String get subscription_tier_freePrice => 'Gratuit';

  @override
  String get subscription_restore_btn => 'Restaurer les achats';
  ...
  String subscription_restore_failed(String error) {
    return 'Échec de la restauration des achats : $error';
  }
  ...
  @override
  String get subscription_tier_freeDesc => 'Idéal pour commencer';

  @override
  String get subscription_tier_premiumDesc =>
      'Accès illimité pour les familles occupées';
  ...
  @override
  String get subscription_feature_sharing_premium => 'Partage familial complet';

  @override
  String get subscription_feature_growth_premium =>
      'Prédictions de croissance et conseils';

  @override
  String get subscription_feature_reminders_premium => 'Rappels saisonniers';
  ...
  String get subscription_cancelAnytime =>
      'Annulez à tout moment. Les articles existants restent visibles même après l\'annulation.';

  @override
  String get addItem_items_limitReached_title => 'Limite d\'articles atteinte';

  @override
  String addItem_items_limitReached_message(int limit) {
    return 'Vous avez atteint la limite de $limit articles pour le niveau gratuit. Passez à Premium pour des articles illimités !';
  }
  ...
  String get members_tooltip_editPermission =>
      'Seuls les administrateurs peuvent modifier d\'autres membres';

  @override
  String get members_button_filter => 'Filtrer';

  @override
  String get members_dialog_limitReached_title => 'Limite Atteinte';

  @override
  String get members_dialog_limitReached_message =>
      'Le niveau gratuit est limité à 4 membres. Passez au plan payant pour des membres illimités et un partage familial complet !';

  @override
  String get members_dialog_limitReached_maybeLater => 'Peut-être Plus Tard';

  @override
  String get members_dialog_limitReached_viewPricing => 'Voir les Tarifs';

  @override
  String get growthChart_premium_title =>
      'Les Prédictions de Croissance sont Premium';

  @override
  String get growthChart_premium_message =>
      'Passez au plan payant pour voir comment vos enfants grandissent et obtenir des conseils sur quand acheter les prochaines tailles.';
  ...
  @override
  String get premium_congrats_title => 'Félicitations !';

  @override
  String get premium_congrats_subtitle =>
      'Vous êtes maintenant membre Premium de SeasonBox.';

  @override
  String get premium_congrats_message =>
      'Merci de nous soutenir ! Vous avez débloqué des articles illimités, le partage familial et bien plus encore.';
